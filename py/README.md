# YoutubeVideo Python SDK



The Python SDK for the YoutubeVideo API — an entity-oriented client following Pythonic conventions.

The SDK exposes the API as capitalised, semantic **Entities** — for example `client.Yts()` — each
...
release tag (`py/vX.Y.Z`, see [Releases](https://github.com/voxgig-sdk/youtube-video-sdk/releases)) or
...
```
py/
├── youtubevideo_sdk.py         -- Main SDK module
