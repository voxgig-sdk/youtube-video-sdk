# YoutubeVideo SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions YoutubeVideoSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both YoutubeVideoSDK(...) and YoutubeVideoSDK.test(...) become
#      YoutubeVideoSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "youtubevideo_sdk"
_SDK_CLASS = "YoutubeVideoSDK"
