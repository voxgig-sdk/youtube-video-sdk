...
class YoutubeVideoTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = YoutubeVideoTestRunner.getenv("YOUTUBEVIDEO_TEST_LIVE")
        override = YoutubeVideoTestRunner.getenv("YOUTUBEVIDEO_TEST_OVERRIDE")
        ...
        explain = YoutubeVideoTestRunner.getenv("YOUTUBEVIDEO_TEST_EXPLAIN")
