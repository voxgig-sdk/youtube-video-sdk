...
from youtubevideo_sdk.utility import register

# Load features
from youtubevideo_sdk.feature.base_feature import YoutubeVideoBaseFeature
from youtubevideo_sdk.features import _has_feature, _make_feature
...
class YoutubeVideoSDK:
    ...
    def __init__(self, options=None):
        ...
        utility = YoutubeVideoUtility()
        self._utility = utility

        from youtubevideo_sdk.config import shared_config
    ...
    def get_utility(self):
        return YoutubeVideoUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("YoutubeVideoSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Yts(self, data=None) -> "YtsEntity":
        ...
        from youtubevideo_sdk.entity.yts_entity import YtsEntity
