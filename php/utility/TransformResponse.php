...
// YoutubeVideo SDK utility: transform_response

require_once __DIR__ . '/../core/Helpers.php';

class YoutubeVideoTransformResponse
{
    public static function call(YoutubeVideoContext $ctx): mixed
    {
        ...
        $transform = YoutubeVideoHelpers::to_map(\Voxgig\Struct\Struct::getprop($point, 'transform'));
        if (!$transform) {
            return null;
        }
