...
// YoutubeVideo SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class YoutubeVideoMakeRequest
{
    public static function call(YoutubeVideoContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new YoutubeVideoResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new YoutubeVideoResponse($fetched);
        } else {
