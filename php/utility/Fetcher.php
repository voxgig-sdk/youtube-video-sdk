...
// YoutubeVideo SDK utility: fetcher
...
class YoutubeVideoFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; YoutubeVideoSDK/1.0)';
    ...
    public static function call(YoutubeVideoContext $ctx, string $fullurl, array $fetchdef): array
    {
