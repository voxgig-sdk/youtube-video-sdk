...
// YoutubeVideo SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (YoutubeVideoSDK::test)
...
{
    private const SDK_CLASS = 'YoutubeVideoSDK';
    ...
    private const SDK_BASE = 'youtubevideo_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../youtubevideo_sdk.php';
