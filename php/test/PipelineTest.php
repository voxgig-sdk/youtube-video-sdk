...
// YoutubeVideo SDK pipeline test
//
...
{
    private static function utility(): YoutubeVideoUtility
    {
        return new YoutubeVideoUtility();
    }
    ...
    private static function ctx(array $over = []): YoutubeVideoContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new YoutubeVideoContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new YoutubeVideoOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof YoutubeVideoError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new YoutubeVideoOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = YoutubeVideoMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new YoutubeVideoOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = YoutubeVideoMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new YoutubeVideoOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = YoutubeVideoMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new YoutubeVideoSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = YoutubeVideoMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new YoutubeVideoResponse([]),
            'result' => new YoutubeVideoResult([]),
        ]);
        [, $err] = YoutubeVideoMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new YoutubeVideoSpec([]),
            'response' => null,
            'result' => new YoutubeVideoResult([]),
        ]);
        [, $err] = YoutubeVideoMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new YoutubeVideoSpec(['step' => 's']),
            'response' => new YoutubeVideoResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new YoutubeVideoResult([]),
        ]);
        [, $err] = YoutubeVideoMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new YoutubeVideoSpec(['step' => 's']),
            'response' => new YoutubeVideoResponse(self::resp(200, ['v' => 1])),
            'result' => new YoutubeVideoResult([]),
        ]);
        [, $err] = YoutubeVideoMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new YoutubeVideoSpec(['step' => 's']),
            'response' => new YoutubeVideoResponse(self::resp(200, ['v' => 2])),
            'result' => new YoutubeVideoResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        YoutubeVideoMakeResponse::call($ctx);
    ...
    {
        $preset = new YoutubeVideoResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new YoutubeVideoSpec([]),
            'response' => new YoutubeVideoResponse([]),
            'result' => new YoutubeVideoResult([]),
        ...
        [$got, $err] = YoutubeVideoMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new YoutubeVideoResult([])]);
        [, $err] = YoutubeVideoMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new YoutubeVideoSpec([]), 'result' => null]);
        [, $err] = YoutubeVideoMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new YoutubeVideoSpec(['step' => 's']),
            'result' => new YoutubeVideoResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new YoutubeVideoOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = YoutubeVideoMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new YoutubeVideoSpec(['step' => 's']),
            'result' => new YoutubeVideoResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new YoutubeVideoOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = YoutubeVideoMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new YoutubeVideoResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new YoutubeVideoSpec([]),
            'result' => new YoutubeVideoResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = YoutubeVideoMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = YoutubeVideoMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new YoutubeVideoError('boom', 'boom');
        $utility->fetcher = function (YoutubeVideoContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new YoutubeVideoSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = YoutubeVideoMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (YoutubeVideoContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = YoutubeVideoMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(YoutubeVideoResponse::class, $response);
    ...
    public function test_make_request_records_the_fetchdef_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->explain = ['on' => true];
        YoutubeVideoMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (YoutubeVideoContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new YoutubeVideoSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = YoutubeVideoMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new YoutubeVideoResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new YoutubeVideoSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = YoutubeVideoMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = YoutubeVideoMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = YoutubeVideoMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new YoutubeVideoResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, YoutubeVideoDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new YoutubeVideoResult(['ok' => false])]);
        $this->expectException(YoutubeVideoError::class);
        YoutubeVideoDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new YoutubeVideoResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', YoutubeVideoMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        YoutubeVideoMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new YoutubeVideoBaseFeature();
        $b = new YoutubeVideoBaseFeature();
        YoutubeVideoFeatureAdd::call($ctx, $a);
        YoutubeVideoFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): YoutubeVideoBaseFeature
    {
        $f = new YoutubeVideoBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        YoutubeVideoFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): YoutubeVideoContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new YoutubeVideoSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = YoutubeVideoPrepareAuth::call($ctx);
    ...
    public function test_prepare_auth_a_raw_apikey_goes_in_as_is(): void
    {
        ...
        YoutubeVideoPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new YoutubeVideoResponse(['headers' => null]),
            'result' => new YoutubeVideoResult([]),
        ]);
        YoutubeVideoResultHeaders::call($ctx);
    ...
    public function test_result_body_skips_parsing_when_the_body_is_absent(): void
    {
        ...
        YoutubeVideoResultBody::call($ctx);
