# YoutubeVideo PHP SDK



The PHP SDK for the YoutubeVideo API — an entity-oriented client using PHP conventions.
...
```php
require_once 'youtubevideo_sdk.php';
$client = new YoutubeVideoSDK($options);
```
...
```
php/
├── youtubevideo_sdk.php          -- Main SDK class
...
The main class (`youtubevideo_sdk.php`) exports the SDK class
