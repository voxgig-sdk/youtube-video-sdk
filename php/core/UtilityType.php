...
// YoutubeVideo SDK utility type

class YoutubeVideoUtility
{
    ...
    public static function copy(YoutubeVideoUtility $src): YoutubeVideoUtility
    {
        $u = new YoutubeVideoUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
