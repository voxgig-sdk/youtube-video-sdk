...
class YoutubeVideoSDK
{
    ...
    public function __construct(array $options = [])
    {
        ...
        $feature_opts = YoutubeVideoHelpers::to_map(Struct::getprop($this->options, "feature"));
        if ($feature_opts) {
            $featureorder = Struct::getpath($this->options, "__derived__.featureorder");
            if (is_array($featureorder)) {
                foreach ($featureorder as $fname) {
                    $fopts = YoutubeVideoHelpers::to_map($feature_opts[$fname] ?? null);
                    if ($fopts && isset($fopts["active"]) && $fopts["active"] === true) {
                        ...
                        if (!YoutubeVideoFeatures::has_feature($fname)) {
                        ...
                        ($utility->feature_add)($this->_rootctx, YoutubeVideoFeatures::make_feature($fname));
                    }
                }
            }
        }
    ...
    {
        return YoutubeVideoUtility::copy($this->_utility);
    }
    ...
    public function prepare(array $fetchargs = []): mixed
    {
        ...
        $ctrl = YoutubeVideoHelpers::to_map(Struct::getprop($fetchargs, "ctrl")) ?? [];
        ...
        $params = YoutubeVideoHelpers::to_map(Struct::getprop($fetchargs, "params")) ?? [];
        $query = YoutubeVideoHelpers::to_map(Struct::getprop($fetchargs, "query")) ?? [];
    ...
    private function op_denied(string $op): array
    {
        ...
        return [
            "ok" => false,
            "err" => new YoutubeVideoError($op . "_allow",
                "YoutubeVideoSDK: " . $op . ": operation not allowed by" .
    ...
    private function raw_request(array $fetchargs = []): mixed
    {
        ...
        if (is_array($fetched)) {
            $status = YoutubeVideoHelpers::to_int(Struct::getprop($fetched, "status"));
    ...
    public function graphql(string $query, ?array $variables = null, ?array $ctrl = null): mixed
    {
        ...
        if (is_array($errors) && 0 < count($errors)) {
            ...
            $res["ok"] = false;
            $res["err"] = new YoutubeVideoError("graphql_error",
                "YoutubeVideoSDK: graphql: " . $msg);
            $res["graphql"] = $errors;
        }
    ...
    public function Yts($data = null)
    {
        ...
        if ($data === null) {
            if ($this->_yts === null) {
                $this->_yts = new YtsEntity($this, null);
            }
            return $this->_yts;
        }
        return new YtsEntity($this, $data);
    }
    ...
    public static function test(?array $testopts = null, ?array $sdkopts = null): self
    {
        ...
        $sdk = new YoutubeVideoSDK($sdkopts);
        $sdk->mode = "test";
        return $sdk;
    }
}
