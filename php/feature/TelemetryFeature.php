...
// YoutubeVideo SDK telemetry feature
...
class YoutubeVideoTelemetryFeature extends YoutubeVideoBaseFeature
{
    ...
    private function _close(YoutubeVideoContext $ctx, bool $ok): void
    {
