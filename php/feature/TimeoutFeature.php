...
// YoutubeVideo SDK timeout feature
...
class YoutubeVideoTimeoutFeature extends YoutubeVideoBaseFeature
{
    ...
    private function _with_timeout(YoutubeVideoContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(YoutubeVideoContext $_ctx, float $ms): void
    {
        $client = $this->client;
