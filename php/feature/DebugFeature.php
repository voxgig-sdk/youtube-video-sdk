...
// YoutubeVideo SDK debug feature
...
class YoutubeVideoDebugFeature extends YoutubeVideoBaseFeature
{
    ...
    private function _finish(YoutubeVideoContext $ctx, bool $ok): void
    {
