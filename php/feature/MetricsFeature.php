...
// YoutubeVideo SDK metrics feature
...
class YoutubeVideoMetricsFeature extends YoutubeVideoBaseFeature
{
    ...
    private function _record(YoutubeVideoContext $ctx, bool $ok): void
    {
