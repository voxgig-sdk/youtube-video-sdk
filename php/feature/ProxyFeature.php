...
// YoutubeVideo SDK proxy feature
...
class YoutubeVideoProxyFeature extends YoutubeVideoBaseFeature
{
    ...
    public function init(YoutubeVideoContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (YoutubeVideoContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
