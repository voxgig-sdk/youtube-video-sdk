...
// YoutubeVideo SDK audit feature
...
class YoutubeVideoAuditFeature extends YoutubeVideoBaseFeature
{
    ...
    private function _emit(YoutubeVideoContext $ctx, string $outcome): void
    {
