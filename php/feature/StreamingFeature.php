...
// YoutubeVideo SDK streaming feature
...
class YoutubeVideoStreamingFeature extends YoutubeVideoBaseFeature
{
    ...
    private function _iterate(YoutubeVideoResult $result): \Generator
    {
    ...
    private function _streamable(YoutubeVideoContext $ctx): bool
    {
