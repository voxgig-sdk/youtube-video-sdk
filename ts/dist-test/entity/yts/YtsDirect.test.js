...
(0, node_test_1.describe)('YtsDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.YoutubeVideoSDK({
    ...
    (0, node_test_1.test)('direct-load-yts', async (t) => {
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-yts', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.YoutubeVideoSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), {}));
        let idmap = env['YOUTUBE_VIDEO_TEST_YTS_ENTID'];
    ...
    const client = new __1.YoutubeVideoSDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=YtsDirect.test.js.map