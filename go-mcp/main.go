// Command YoutubeVideo-mcp is an MCP server exposing the YoutubeVideo
// SDK as MCP tools.
//
// Two tools are registered:
//
//	YoutubeVideo_list  — list records of an entity
//	YoutubeVideo_load  — load a single record of an entity
//
