...
func NewYtsEntity(client *core.YoutubeVideoSDK, entopts map[string]any) *YtsEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *YtsEntity) GetName() string { return e.name }
...
func (e *YtsEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *YtsEntity) Deleted() bool {
	return e.deleted
}


func (e *YtsEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewYtsEntity(e.client, opts)
}

func (e *YtsEntity) Data(args ...any) any {
...
func (e *YtsEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Yts; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *YtsEntity) DataTyped(data ...Yts) Yts {
	if len(data) > 0 {
		return typedFrom[Yts](e.Data(asMap(data[0])))
	}
	return typedFrom[Yts](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Yts (all fields
// optional at the wire level).
func (e *YtsEntity) MatchTyped(match ...Yts) Yts {
	if len(match) > 0 {
		return typedFrom[Yts](e.Match(asMap(match[0])))
	}
	return typedFrom[Yts](e.Match())
}
...
func (e *YtsEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *YtsEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// YtsLoadMatch and returns an Yts. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *YtsEntity) LoadTyped(reqmatch YtsLoadMatch, ctrl map[string]any) (Yts, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Yts{}, err
	}
	return typedFrom[Yts](res), nil
}



func (e *YtsEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *YtsEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *YtsEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *YtsEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *YtsEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
