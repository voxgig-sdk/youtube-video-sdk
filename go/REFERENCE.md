# YoutubeVideo Golang SDK Reference

Complete API reference for the YoutubeVideo Golang SDK.
...
#### `TestSDK(testopts, sdkopts map[string]any) *YoutubeVideoSDK`
...
#### `Yts(data map[string]any) YoutubeVideoEntity`
...
```go
result, err := client.Yts(nil).Load(map[string]any{"text": "text"}, nil)
if err != nil {
    panic(err)
}
fmt.Println(result)
