...
func (sdk *YoutubeVideoSDK) OptionsMap() map[string]any {
...
func (sdk *YoutubeVideoSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *YoutubeVideoSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *YoutubeVideoSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *YoutubeVideoSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *YoutubeVideoSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *YoutubeVideoSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("YoutubeVideoSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *YoutubeVideoSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *YoutubeVideoSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("YoutubeVideoSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
...
func TestSDK(testopts map[string]any, sdkopts map[string]any) *YoutubeVideoSDK {
	...
	sdk := NewYoutubeVideoSDK(sdkopts)
	sdk.Mode = "test"
