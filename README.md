...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/youtube-video` | `npm install @voxgig-sdk/youtube-video` |
| Python | `voxgig-sdk-youtube-video` | `pip install voxgig-sdk-youtube-video` |
| PHP | `voxgig-sdk/youtube-video` | `composer require voxgig-sdk/youtube-video` |
| Golang | `github.com/voxgig-sdk/youtube-video-sdk/go` | `go get github.com/voxgig-sdk/youtube-video-sdk/go` |
| Ruby | `voxgig-sdk-youtube-video` | `gem install voxgig-sdk-youtube-video` |
| Lua | `voxgig-sdk-youtube-video` | `luarocks install voxgig-sdk-youtube-video` |
