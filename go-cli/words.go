...
func registerSDKWords(r *eng.Registry, client *sdk.YoutubeVideoSDK) {
...
func runOp(client *sdk.YoutubeVideoSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
