...
#      offline in seeded test mode (YoutubeVideoSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "YoutubeVideo_sdk.rb")
  SDK_CLASS = "YoutubeVideoSDK"
