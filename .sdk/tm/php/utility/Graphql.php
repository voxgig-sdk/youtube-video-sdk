...
// YoutubeVideo SDK utility: graphql
//
...
class YoutubeVideoGraphql
{
    ...
    // equivalent.
    public static function body(YoutubeVideoContext $ctx): mixed
    {
    ...
    public static function errors(YoutubeVideoContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
