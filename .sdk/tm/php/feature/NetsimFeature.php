...
// YoutubeVideo SDK netsim feature
...
class YoutubeVideoNetsimFeature extends YoutubeVideoBaseFeature
{
    ...
    private function _simulate(YoutubeVideoContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(YoutubeVideoContext $ctx, array $applied): void
    {
        $client = $this->client;
