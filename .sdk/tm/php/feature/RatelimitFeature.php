...
// YoutubeVideo SDK ratelimit feature
...
class YoutubeVideoRatelimitFeature extends YoutubeVideoBaseFeature
{
    ...
    private function _acquire(YoutubeVideoContext $ctx): void
    {
    ...
    private function _track(YoutubeVideoContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
