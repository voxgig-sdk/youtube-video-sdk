...
// YoutubeVideo SDK cache feature
...
class YoutubeVideoCacheFeature extends YoutubeVideoBaseFeature
{
    ...
    private function _through(YoutubeVideoContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
