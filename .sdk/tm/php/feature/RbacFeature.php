...
class YoutubeVideoRbacFeature extends YoutubeVideoBaseFeature
{
    ...
    private function _required(YoutubeVideoContext $ctx): ?string
    {
    ...
    private function _reject(YoutubeVideoContext $ctx, string $required): void
    {
    ...
    private function _track(YoutubeVideoContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
