...
// YoutubeVideo SDK clienttrack feature
...
class YoutubeVideoClienttrackFeature extends YoutubeVideoBaseFeature
{
    ...
    public function PostConstruct(YoutubeVideoContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'YoutubeVideo-SDK';
