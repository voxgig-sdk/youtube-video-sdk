...
// YoutubeVideo SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = YoutubeVideoOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(YoutubeVideoOmni::structfix($now, Struct::undef()))
                        !== json_encode(YoutubeVideoOmni::structfix($val, Struct::undef()))) {
