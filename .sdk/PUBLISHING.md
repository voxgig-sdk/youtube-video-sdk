...
|---|---|---|
| `ts/` | @voxgig-sdk/youtube-video-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/youtube-video-sdk \
      --repository voxgig-sdk/youtube-video-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/youtube-video-sdk` shows it, and
`npm trust revoke @voxgig-sdk/youtube-video-sdk --id=<id>` removes it.
