...
describe("YtsDirect", function()
  it("should direct-load-yts", function()
    local setup = yts_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-yts", setup.live and "live" or "unit")
...
function yts_direct_setup(mockres)
  ...
  local live = env["YOUTUBEVIDEO_TEST_LIVE"] == "TRUE"
