...
describe("YtsEntity", function()
  ...
  it("should run basic flow", function()
    ...
    if setup.synthetic_only then
      pending("live entity test uses synthetic IDs from fixture — set YOUTUBEVIDEO_TEST_YTS_ENTID JSON to run live")
      return
    end
...
function yts_basic_setup(extra)
  ...
  local entid_env_raw = os.getenv("YOUTUBEVIDEO_TEST_YTS_ENTID")
